...
public class FirebaseStorageManager {
    ...
    public void UploadGroupFile(String groupId, Uri file, IAction action, ExecutorService executorService) {
        executorService.execute(() -> {
            ...
            StorageReference fileReference = mStorage.getReference().child(groupId).child(fileName.split(" ")[0]).child(fileName);
